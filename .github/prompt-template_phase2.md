...
Task:
Complete TASKS.md item [Phase 2.8: Artifact Identity and Naming Rules] ([Phase 2.8: Artifact Identity and Naming Rules]).
...
Now implement [Phase 2.8: Artifact Identity and Naming Rules].